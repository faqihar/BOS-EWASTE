	...
	while ($row=mysqli_fetch_array($result))
	{
		...
		if($datenow >= $duedate){
           ...
           $buyer=$row['Buyer'];
            ...
            $message="Selamat Kepada.".$sname.", barang kamu ".$ProductName." telah ditawar oleh ".$bname.".Kamu bisa kontak dia dengan Email:".$bemail." atau menggunakan telepon:".$bphone.".";
            $query1="insert into Notification values('$seller','$message','No')";
            mysqli_query($connection,$query1);  
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a href="#"><img src="image/favicon.png" height="50px"/></a>
    </div>
...
<?php
  ...
  if($sdate<=$datenow){
    echo'<td>';
    echo"<img src='".$row['Image']."' width='220px' height='220px'><br>";
    echo'</td>';
    echo'<td>';
